...
| Phase 2: Analysis | {{PHASE2_STATUS}} | {{PHASE2_TOTAL}} | {{PHASE2_COMPLETED}} | {{PHASE2_FAILED}} |
| Phase 3: Model | {{PHASE3_STATUS}} | {{PHASE3_TOTAL}} | {{PHASE3_COMPLETED}} | {{PHASE3_FAILED}} |
| Phase 4: Final | {{PHASE4_STATUS}} | - | - | - |
...
- **Successfully Processed**: {{SUCCESS_DOCUMENTS}}
